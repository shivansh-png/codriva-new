        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-[#24292f] dark:text-[#f0f6fc] mb-6">
              {t('pages:servicesPage.services.supportMaintenance.title')}
            </h1>
            ...
            <div className="space-y-6">
              <p className="text-lg text-[#656d76] dark:text-[#8b949e] leading-relaxed">
                <span className="text-[#0969da] font-semibold">
                  {t('pages:servicesDetail.supportMaintenance.highlight')}
                </span>{" "}
                {t('pages:servicesDetail.supportMaintenance.description')}
              </p>
            </div>
            <div className="relative">
              <Image
                src="/assets/images/technology-technical.png"
                alt={t('pages:servicesPage.services.supportMaintenance.title')}
                width={600}
                height={400}
