        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-[#24292f] dark:text-[#f0f6fc] mb-6">
              {t('pages:servicesPage.services.mobileApp.title')}
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start mb-4">
            <div className="relative">
              <Image
                ...
                alt={t('pages:servicesPage.services.mobileApp.title')}
                width={600}
                height={400}
            ...
            <div className="space-y-6">
              <p className="text-lg text-[#656d76] dark:text-[#8b949e] leading-relaxed">
                ...
                {t('pages:servicesDetail.mobileApp.description1')}
              </p>
              <p className="text-lg text-[#656d76] dark:text-[#8b949e] leading-relaxed">
                {t('pages:servicesDetail.mobileApp.description2')}
              </p>
              <p className="text-lg text-[#656d76] dark:text-[#8b949e] leading-relaxed">
                {t('pages:servicesDetail.mobileApp.description3')}
              </p>
            </div>
          </div>
        </div>
