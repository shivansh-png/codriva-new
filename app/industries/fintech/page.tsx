    ...
    const solutions = [
        {
            ...
            image: '/assets/images/unsplash_5.png',
            points: [
            ...
            <div ref={innovateRef} className="py-20 bg-gray-50 dark:bg-gray-900">
                <div className="container-max">
                    ...
                    <div className="max-w-4xl mx-auto text-lg text-gray-600 dark:text-gray-300 leading-relaxed space-y-6">
                        <p>The FinTech and Banking sector is undergoing rapid transformation, driven by digital innovation and changing consumer expectations. At Codriva, we develop cutting-edge financial technology solutions that enhance security, efficiency, and user experience across the financial ecosystem.</p>
                        <p>Our expertise spans digital banking platforms, payment processing systems, blockchain integration, and regulatory compliance tools. We leverage advanced technologies like AI, machine learning, and distributed ledger technology to create secure, scalable, and user-friendly financial solutions.</p>
                        <p>Codriva's FinTech solutions prioritize security, compliance, and seamless integration with existing financial systems. Our platforms support everything from mobile banking and payment processing to investment management and risk assessment, helping financial institutions stay competitive in a rapidly evolving market.</p>
                        <p>With a focus on innovation and regulatory compliance, Codriva empowers banks, fintech startups, and financial service providers to deliver exceptional digital experiences while maintaining the highest standards of security and trust.</p>
                    </div>
                </div>
            </div>
