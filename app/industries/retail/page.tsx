            ...
            <div ref={innovateRef} className="py-20 bg-gray-50 dark:bg-gray-900">
                <div className="container-max">
                    ...
                    <div className="max-w-4xl mx-auto text-lg text-gray-600 dark:text-gray-300 leading-relaxed space-y-6">
                        <p>In today's fast-paced digital marketplace, Retail and E-Commerce businesses face the challenge of delivering seamless, personalized shopping experiences while managing complex operations. At Codriva, we specialize in developing innovative software solutions tailored to the unique needs of this dynamic sector. Our expertise spans building scalable e-commerce platforms, integrating secure payment gateways, and optimizing inventory and supply chain management to enhance operational efficiency.</p>
                        <p>We empower retailers to leverage data-driven insights for targeted marketing, customer engagement, and loyalty programs that drive repeat business. From mobile shopping apps to omnichannel retail solutions, our technology ensures your customers enjoy consistent, frictionless experiences across every touchpoint. Additionally, we prioritize robust security measures and compliance with industry standards to protect sensitive customer information and build trust.</p>
                        <p>Whether launching a new online store or modernizing legacy systems, Codriva's Retail and E-Commerce solutions help businesses adapt to evolving market trends, increase sales, and gain a competitive edge in an ever-changing landscape.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="py-20 bg-blue-600 text-white">
                <div className="container-max text-center">
                    ...
                    <p className="text-xl mb-8 max-w-2xl mx-auto">
                        Let's discuss how we can help you innovate and grow in the digital marketplace.
                    </p>
                    <Link
                        href="/contact"
