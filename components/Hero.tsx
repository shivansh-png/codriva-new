  ...
  const expertiseData = [
    {
      ...
      title: t('home:hero.expertise.teamExperience'),
      subtitle: t('home:hero.expertise.teamExperienceSubtitle'),
    },
    {
      image: "/assets/images/776922_more10.jpg",
      title: t('home:hero.expertise.industriesServed'),
      subtitle: t('home:hero.expertise.industriesServedSubtitle'),
    },
    {
      image: "/assets/images/422093080_80671624-b25f-4674-8409-a236ee5f8426.jpg",
      title: t('home:hero.expertise.engineeringCulture'),
      subtitle: t('home:hero.expertise.engineeringCultureSubtitle'),
    },
    {
      image: "/assets/images/4815.png",
      title: t('home:hero.expertise.deliveryCommitment'),
      subtitle: t('home:hero.expertise.deliveryCommitmentSubtitle'),
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        >
          <source src="/videos/landing-new.mp4" type="video/mp4" />
